...
def test_missingFen():
    ...
    assert test.fenElementDict.get('fenHalfMove') == '0'
    assert test.fenElementDict.get('fenMove') == '1'
...
def test_invalidCharInBoard():
    ...
    assert test.fenElementDict.get('fenCastling') == 'KQkq'
    assert test.fenElementDict.get('fenEP') == '-'
    assert test.fenElementDict.get('fenHalfMove') == '1'
    assert test.fenElementDict.get('fenMove') == '2'
...
def test_noWhiteKing():
    ...
    test = Fen(fen ='rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQQB1R b KQkq - 1 2',
                testList = ['board'])
    # temporary: reset board to starting position
    assert test.fenElementDict.get('fenBoard') == 'rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQQB1R'
    assert test.fenElementDict.get('fenToPlay') == 'b'
    # no white king
...
def test_manyWhiteKings():
    test = Fen(fen = 'rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKK1R b KQkq - 1 2',
                testList = ['board'])
    # temporary: reset board to starting position
    assert test.fenElementDict.get('fenBoard') == 'rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKK1R'
    assert test.fenElementDict.get('fenToPlay') == 'b'
    assert test.fenElementDict.get('fenCastling') == 'KQkq'
    assert test.fenElementDict.get('fenEP') == '-'
    assert test.fenElementDict.get('fenHalfMove') == '1'
...
def test_noBlackKing():
    test = Fen(fen = 'rnbqqbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2',
                testList = ['board'])
    # temporary: reset board to starting position
    assert test.fenElementDict.get('fenBoard') == 'rnbqqbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R'
    assert test.fenElementDict.get('fenToPlay') == 'b'
    #no black king
    assert test.fenElementDict.get('fenCastling') == 'KQ'
    assert test.fenElementDict.get('fenEP') == '-'
...
def test_manyBlackKings():
    test = Fen(fen = 'rnbqkknr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2',
                testList = ['board'])
    # temporary: reset board to starting position
    assert test.fenElementDict.get('fenBoard') == 'rnbqkknr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R'
    assert test.fenElementDict.get('fenToPlay') == 'b'
    assert test.fenElementDict.get('fenCastling') == 'KQkq'
    assert test.fenElementDict.get('fenEP') == '-'
    assert test.fenElementDict.get('fenHalfMove') == '1'
...
def test_validHalfMove():
    ...
    assert test.fenElementDict.get('fenCastling') == 'KQkq'
    assert test.fenElementDict.get('fenEP') == '-'
    assert test.fenElementDict.get('fenHalfMove') == '3'
    assert test.fenElementDict.get('fenMove') == '5'
...
def test_fenElements(good_fen):
    ...
    assert good_fen.fenElementDict.get('fenEPHalfMove') == '1'
...
def test_fenElements(good_ep_fen):
    ...
    assert good_ep_fen.fenElementDict.get('fenHalfMove') == '1'
    assert good_ep_fen.fenElementDict.get('fenMove') == '2'
